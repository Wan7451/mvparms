...
public class GlobeConfigModule {
    private HttpUrl mApiUrl;  //基础url
    private GlobeHttpHandler mHandler;  //用来处理http响应结果
    private List<Interceptor> mInterceptors; //动态添加任意个interceptor
    private ResponseErroListener mErroListener; //处理所有Rxjava的onError逻辑
    private File mCacheFile; //提供缓存地址
